...
var MsgExecuteContract = /** @class */ (function (_super) {
    ...
    MsgExecuteContract.fromData = function (data) {
        ...
        return new MsgExecuteContract(sender, contract, contract_1.b64ToDict(execute_msg), Coins_1.Coins.fromData(coins));
    };
    MsgExecuteContract.prototype.toData = function () {
        ...
        return {
            ...
            value: {
                sender: sender,
                contract: contract,
                execute_msg: contract_1.dictToB64(execute_msg),
                coins: coins.toData(),
            },
        };
    };
