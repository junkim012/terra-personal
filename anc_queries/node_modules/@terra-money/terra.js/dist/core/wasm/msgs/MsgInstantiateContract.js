...
var MsgInstantiateContract = /** @class */ (function (_super) {
    ...
    MsgInstantiateContract.fromData = function (data) {
        ...
        return new MsgInstantiateContract(owner, Number.parseInt(code_id), contract_1.b64ToDict(init_msg), Coins_1.Coins.fromData(init_coins), migratable);
    };
    MsgInstantiateContract.prototype.toData = function () {
        ...
        return {
            ...
            value: {
                ...
                init_msg: contract_1.dictToB64(init_msg),
